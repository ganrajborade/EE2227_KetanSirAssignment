...
\end{table}
\\
Since from the equation \eqref{eq:ee18btech11016_system_equation}, P = 2 as the number of poles on right hand side of s-plane is equal to 2 (from \eqref{eq:ee18btech11016_system_equation}). So,for Z to be equal to 0 ,we have to choose the range of K such that N should be equal to -2.
\\
